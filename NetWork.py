...
#         # x_channel_atten = self.lbn(x)
#         # x_channel_atten = self.sigmoid(x_channel_atten)
...
#         # print(x_spacial_atten.size())
#         # x_w = self.fc_w(x)
#         # x_c = torch.sum(x, dim = 1)
#         # return x_spacial_atten
#         return  x_spacial_atten

# # class self_adaption(nn.Module):
# #     def __init__(self):
# #         super(self_adaption, self).__init__()
# #
# #     def forward(self, x_w_p, x_w_n, x_c_p, x_c_n):
# #         x_w = torch.cat((x_w_p, x_w_n), dim=1)
# #         x_c_p = x_c_p.view(-1, 1)
# #         x_c_n = x_c_n.view(-1, 1)
# #         x_c_1 = torch.cat((x_c_p, x_c_n), dim=1)
# #         x_c_1 = x_w * x_c_1
# #         return x_c_1
...
#     def forward(self, x_spacial_atten,x_fea):
...
#         # self.adapt = self_adaption()
#         self.classify_2 = class_branch_2()


#     def forward(self, x):
#         x_fea = self.fcn(x)
#         # x_c_p, x_spacial_atten_p, x_w_p = self.p_branch(x_fea)
#         # x_c_n, x_spacial_atten_n, x_w_n = self.n_branch(x_fea)
#         x_spacial_atten_p = self.p_branch(x_fea)
#         # x_w_n,x_spacial_atten_n, x_2_n = self.n_branch(x_fea)
#         # x_c_2_1 = torch.cat((x_2_p, x_2_n), dim=1)
#         # x_w = torch.cat((x_w_p, x_w_n), dim=1)
#         # x_w = F.softmax(x_w,dim=1)
#         x_c_2_2 = self.classify_2(x_spacial_atten_p,x_fea)
#         # x_c_2_2 = x_w + x_c_2_2
